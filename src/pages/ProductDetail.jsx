    ...
    <>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 animate-fade-in-up">
        ...
        <div className="space-y-5">
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider text-[var(--color-accent)] bg-[var(--color-accent-subtle)] border border-[var(--color-accent)]/20 hover:bg-[var(--color-accent-subtle)]/80 hover:border-[var(--color-accent)]/40 transition-all cursor-pointer animate-pulse w-fit whitespace-nowrap flex-shrink-0"
              >
                <span>Scroll to buy</span>
            ...
            <div className="text-[var(--color-text)]/85 mt-4 text-sm sm:text-base leading-relaxed space-y-4 whitespace-pre-wrap">
          ...
          <div id="purchase-options" className="space-y-3 pt-2">
